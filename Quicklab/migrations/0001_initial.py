# Generated by Django 4.0.6 on 2022-10-01 19:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=8)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Teacher_student', to='Quicklab.student')),
            ],
        ),
        migrations.CreateModel(
            name='Practical',
            fields=[
                ...
                ('tools', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Tools', to='Quicklab.tool')),
            ],
        ),
    ]
